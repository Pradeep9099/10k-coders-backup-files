                ...
                <table className="table">
                    ...
                    <tbody>
                        {persons.map((person, i) => <tr key={i}>
                            ...
                            <td>{person.lname}</td>
                            <td>{person.email}</td>
                            <td><button className="btn btn-warning">Edit Person</button></td>
                            <td><button className="btn btn-danger" onClick={()=>{this.props.deletePerson(person)}}>Delete Person</button></td>
                        </tr>)}
                    </tbody>
                </table>
            </div>
